...
Global Const $SMTP_PORT = IniRead($INI_FILE, "pop3_info", "smtp_port", "25")
...
Global Const $APP_TITLE = "远程控制"
Global Const $POP3_SERVER = IniRead($INI_FILE, "pop3_info", "pop", "error")
Global Const $POP3_PORT = IniRead($INI_FILE, "pop3_info", "pop_port", "110")
Global Const $POP3_USER = IniRead($INI_FILE, "pop3_info", "user", "error")
Global Const $POP3_PWD = IniRead($INI_FILE, "pop3_info", "pwd", "error")
