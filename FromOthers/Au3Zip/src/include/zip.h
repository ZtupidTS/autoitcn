...
// The following was added by sp.
#define ZR_ABORT      0x06000000    // the user aborted task
...
#endif
#endif
ZRESULT AddDirToZip(const TCHAR *zipfn, const TCHAR *zedir, bool *b_recurse);
ZRESULT AddDirToZip(HZIP hz, const TCHAR *zedir, bool *b_recurse);
